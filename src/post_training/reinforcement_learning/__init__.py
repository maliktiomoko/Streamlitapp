...
from src.post_training.reinforcement_learning.random import contextual_bandit_random
from src.post_training.reinforcement_learning.bandit import (ContextualBanditSuccessiveRejects, ContextualBanditUniformBAI,
                                               ContextualBanditSuccessiveHalving, ContextualBanditLUCB)
from src.post_training.reinforcement_learning.rl import contextual_bandit_reinforcement
from src.post_training.reinforcement_learning.genetic import genetic_algorithm_reinforcement
...
def explore_instructions(
    ...
    best_function_set_per_channel, best_mse, best_pred, true, batch_x = rl_algorithm(
        ...
        streamlit=streamlit, feedback=feedback
    )
